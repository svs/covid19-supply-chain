...
import { list, addCircle, hammer, help, informationCircle, logIn, logOut, map, person, personAdd } from 'ionicons/icons';
...
const routes = {
  appPages: [
    ...
    { title: 'List', path: '/tabs/list', icon: list },
    { title: 'Report', path: '/tabs/report', icon: addCircle },
